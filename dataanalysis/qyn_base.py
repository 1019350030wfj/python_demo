# 从百度百科下载的文中的人物名字，并帅选出重复的名字，保存在列表里
...
# 我们从最简单的做起，统计任务出现次数
def find_people_showup_count(num=10):
    '''
    对比统计人物姓名出现的次数，
    并返回出现次数最多的前Num个人
    '''
...
# 简单的展示一下数据
showup_10 = find_people_showup_count()
print(showup_10)
...
# Gensim中的word2Vec期望的输入是经过分词的
# 句子列表。既是一个包含句子分词结果的二维码数组
