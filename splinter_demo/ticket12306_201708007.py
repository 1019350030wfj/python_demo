...
class LoginTic(object):
    ...
    def getImg(self):
        url = "https://kyfw.12306.cn/passport/captcha/captcha-image?login_site=E&module=login&rand=sjrand&0.6909870647179148";
        ...
        # ---------------------------------------
        # =======================================================================
        captcha_solution = raw_input(u'请输入验证码位置，以","分割[例如2,5]:')
    ...
    def loginTo(self):
        ...
        print result.content.encode('utf-8')
